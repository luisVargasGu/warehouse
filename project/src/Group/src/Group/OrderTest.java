...
public class OrderTest {
	...
	public void Test1CreateOrder() {
		...
		assertTrue(o1.getOrderNum() == 5);// if u just run test suite, as there are orders created in other tests
	}
	...
	public void Test4OrderNum() {
		...
		assertTrue(o1.getOrderNum() == 9);// if u just run test suite, as there are orders created in other tests
		assertTrue(o2.getOrderNum() == 10);// if u just run test suite, as there are orders created in other tests
	}
